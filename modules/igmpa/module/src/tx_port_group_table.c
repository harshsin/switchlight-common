...
of_port_no_t
tx_port_group_lookup(uint16_t table_id, of_object_t *key)
{
    tx_port_group_entry_t *entry;
...
void
tx_port_group_stats_show(aim_pvs_t *pvs)
{
...
void
tx_port_group_table_finish(void)
{
