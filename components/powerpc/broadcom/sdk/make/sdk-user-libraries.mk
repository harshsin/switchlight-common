...
userlibs:
	$(MAKE) -C $(SDK)/systems/switchlight/powerpc/$(SDK_CONFIG) SDK=$(SDK) userlibs
	cp $(SDK)/build/switchlight/powerpc/$(SDK_CONFIG)/libbroadcom.so $(LIBRARY_DIR)/libbroadcom-$(SDK_CONFIG).so.$(SDK_LIB_VERSION)
	cp $(SDK)/build/switchlight/powerpc/$(SDK_CONFIG)/libbroadcom.a $(LIBRARY_DIR)/libbroadcom-$(SDK_LIB_VERSION)-$(SDK_CONFIG).a
	cp $(SDK)/build/switchlight/powerpc/$(SDK_CONFIG)/version.o $(LIBRARY_DIR)/version.o
